...
public class CoachServiceImpl implements CoachService {
    ...
    @Override
    public List<CoachOrder> getCoachOrderByUid(Integer uid) {
        return coachMapper.queryCoachOrderByUid(uid);
    }

    @Override
    public void updateCorderByConum(String conum) {
        coachMapper.updCorderByConum(conum);
    }

    //插入订单
    @Override
    public void addOrderByUid(String conum, String coname, double cmoney, Integer uid) {
        coachMapper.insertCorder(conum, coname, cmoney, uid);
    }
    ...
    @Override
    public double selMoneyByUid(Integer uid) {
    ...
    @Override
    public double findCmoneyByUid(Integer uid) {
        return coachMapper.queryMoneyByUid(uid);
    }

    /*教练修改信息*/
    @Override
    public Integer changeCoach(Coach coach) {
        return coachMapper.updateByUidKeySelective(coach);
    }
    ...
    public List<Communication> showTips(Integer uid) {
        return coachMapper.showTips(uid,CoachComm.COMM_NO);
    }

    @Override
    public void updateCommState(String sendName, String receiveName) {
        coachMapper.updateCommState(sendName,receiveName,CoachComm.COMM_YES);
    }
}
