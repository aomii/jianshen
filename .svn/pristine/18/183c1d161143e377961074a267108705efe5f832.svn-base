...
public class OrderController {
    ...
    public String alipay(String outTradeNo, String subject, String totalAmount, String body, HttpServletRequest request, Integer banKaId, Integer qianYueCid, Integer gid) throws AlipayApiException {
